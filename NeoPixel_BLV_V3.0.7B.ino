...
//Heater_Scale[2] = 20; //Temperature steps at which the following LEDs light up
  ...
  NeoPixelPrinterstatus_ArduinoPin= 7; //Arduino pin used to control the Neopixel (do not change if using the wiring diagram from Ben Levi)
  ...
  NeoPixelHeater_ArduinoPin[0]= 8; //Arduino pin used to control the Neopixel (do not change if using the wiring diagram from Ben Levi)
  ...
  NeoPixelHeater_ArduinoPin[1]= 6; //Arduino pin used to control the Neopixel (do not change if using the wiring diagram from Ben Levi)
