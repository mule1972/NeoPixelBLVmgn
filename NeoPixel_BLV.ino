...
//General
bool NeoPixelStartupAnimation= true; //Show StartupAnimation for all Neopixels (true = activated / false = deactivated) !!Attention!! Animation can only be shown if each Neopixel used has the same amount of LEDs
